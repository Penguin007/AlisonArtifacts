...
namespace ArtifactsApp.Controllers
{
    public class SourcesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BusinessName,Addr1,Addr2,City,State,Zip,Country,Phone,Email,SiteUrl,Hours,IsCommercial")] Source source)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BusinessName,Addr1,Addr2,City,State,Zip,Country,Phone,Email,SiteUrl,Hours,IsCommercial")] Source source)
        {
            if (id != source.Id)
            {
                return NotFound();
