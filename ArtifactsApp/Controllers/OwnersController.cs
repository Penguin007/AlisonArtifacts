...
namespace ArtifactsApp.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Organization")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Organization")] Owner owner)
        {
            if (id != owner.Id)
            {
                return NotFound();
